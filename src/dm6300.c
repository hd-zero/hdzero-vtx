...
void DM6300_write_reg_map(const dm6300_reg_value_t *reg_map, uint8_t size) {
    ...
    for (i = 0; i < size; i++) {
        ...
        SPI_Write(reg_map[i].trans, reg_map[i].addr, reg_map[i].dat_h, reg_map[i].dat_l);
    }
}
...
const dm6300_reg_value_t dm6300_init1_regs[] = {
    ...
    {0x6, 0xF1C, 0x00000000, 0x00000001},
    {0x6, 0xF20, 0x00000000, 0x0000FCD0},
    {0x6, 0xF04, 0x00000000, 0x00004741},
    {0x6, 0xF08, 0x00000000, 0x00000083},
    {0x6, 0xF08, 0x00000000, 0x000000C3},
    {0x6, 0xF40, 0x00000000, 0x00000003},
    {0x6, 0xF40, 0x00000000, 0x00000001},
    {0x6, 0xFF0, 0x00000000, 0x00000018},
    {0x6, 0xFFC, 0x00000000, 0x00000000},
    {0x6, 0xFFC, 0x00000000, 0x00000001},
    {0x0, 0x000, 0x00000000, 0x00000000}, // padding
};
...
const dm6300_reg_value_t dm6300_init2_regs_bw20[] = {
    ...
    {0x3, 0x230, 0x00000000, 0x00000000},
    {0x3, 0x234, 0x00000000, 0x10000000},
    {0x3, 0x238, 0x00000000, 0x000000BF},
    {0x3, 0x23C, 0x00000000, 0x55530610}, // 0x15840410  0x15530610
    {0x3, 0x240, 0x00000000, 0x3FFC0047}, // 0x0001C047  0x3FFC0047
    {0x3, 0x244, 0x00000000, 0x00188A13}, // 0x00188A17
    {0x3, 0x248, 0x00000000, 0x00000000},
    {0x3, 0x24C, 0x00000000, 0x0A121707}, // 0x08021707
    {0x3, 0x250, 0x00000000, 0x017F0001},
    {0x3, 0x218, 0x00000000, 0x00000000},
    {0x3, 0x228, 0x00000000, 0x0000807A},
    {0x3, 0x220, 0x00000000, 0x00002FA8}, // 0x00002666
    {0x3, 0x21C, 0x00000000, 0x00000002},
    {0x3, 0x218, 0x00000000, 0x00000000},
    {0x3, 0x218, 0x00000000, 0x00000001},
    {0x3, 0x218, 0x00000000, 0x00000000},
    {0x3, 0x21C, 0x00000000, 0x00000003},
    {0x3, 0x218, 0x00000000, 0x00000001},
    {0x3, 0x218, 0x00000000, 0x00000000},
    {0x3, 0x244, 0x00000000, 0x00188A17},
    {0x3, 0x204, 0x00000000, 0x00000032}, // 0x0000004c
    {0x3, 0x208, 0x00000000, 0x00000000}, // 0x00666666
    {0x3, 0x200, 0x00000000, 0x00000000},
    {0x3, 0x200, 0x00000000, 0x00000003},
    {0x3, 0x240, 0x00000000, 0x00030041}, // 0x0003C045
    {0x3, 0x248, 0x00000000, 0x00000404},
    {0x3, 0x250, 0x00000000, 0x0F7F0001},
...
const dm6300_reg_value_t dm6300_init2_regs_bw27[] = {
    ...
    {0x6, 0xFF0, 0x00000000, 0x00000018},
    {0x3, 0x2AC, 0x00000000, 0x00000300},
    {0x3, 0x2B0, 0x00000000, 0x00077777},
    {0x3, 0x230, 0x00000000, 0x00000000},
    {0x3, 0x234, 0x00000000, 0x10000000},
    {0x3, 0x238, 0x00000000, 0x000000BF},
    {0x3, 0x23C, 0x00000000, 0x15530610}, // 0x15840410  0x15530610
    {0x3, 0x240, 0x00000000, 0x3FFC0047}, // 0x0001C047  0x3FFC0047
    {0x3, 0x244, 0x00000000, 0x00188A13}, // 0x00188A17
    {0x3, 0x248, 0x00000000, 0x00000000},
    {0x3, 0x24C, 0x00000000, 0x0A161707}, // 0x08021707
    {0x3, 0x250, 0x00000000, 0x017F0001},
    {0x3, 0x218, 0x00000000, 0x00000000},
    {0x3, 0x228, 0x00000000, 0x00008083},
    {0x3, 0x220, 0x00000000, 0x00002E0E}, // 0x00002666
    {0x3, 0x21C, 0x00000000, 0x00000002},
    {0x3, 0x218, 0x00000000, 0x00000001},
    {0x3, 0x218, 0x00000000, 0x00000000},
    {0x3, 0x21C, 0x00000000, 0x00000003},
    ...
    {0x3, 0x218, 0x00000000, 0x00000000},
    {0x3, 0x244, 0x00000000, 0x00188A17},
    {0x3, 0x204, 0x00000000, 0x0000002D}, // 0x0000004c
    {0x3, 0x208, 0x00000000, 0x00000000}, // 0x00666666
    {0x3, 0x200, 0x00000000, 0x00000000},
    {0x3, 0x200, 0x00000000, 0x00000003},
    {0x3, 0x240, 0x00000000, 0x00030041}, // 0x0003C045
    ...
    {0x3, 0x250, 0x00000000, 0x0F7F0001},
    {0x3, 0x254, 0x00000000, 0x00007813}, // 0x00007813
    {0x3, 0x258, 0x00000000, 0x00010002},
    {0x0, 0x000, 0x00000000, 0x00000000}, // pad to the same size
};
...
const dm6300_reg_value_t dm6300_init4_regs[] = {
    ...
    {0x3, 0x300, 0x00000000, 0xC000281B},
    {0x3, 0x304, 0x00000000, 0x0CC00006},
    {0x3, 0x308, 0x00000000, 0x00000000},
    {0x3, 0x30C, 0x00000000, 0x00000000},
    {0x3, 0x310, 0x00000000, 0xFFFFFF14},
    {0x3, 0x314, 0x00000000, 0x4B7FFFE0},
    {0x3, 0x318, 0x00000000, 0xFFFFFFFF},
    {0x3, 0x320, 0x00000000, 0x00008000},
    {0x3, 0x324, 0x00000000, 0x0000004C},
    {0x3, 0x328, 0x00000000, 0x00000000},
    {0x3, 0x32C, 0x00000000, 0x00000000},
    {0x3, 0x330, 0x00000000, 0x00000000}, // remove init DC high
    {0x3, 0x334, 0x00000000, 0x00000000},
    {0x3, 0x31C, 0x00000000, 0x00000011},
};
...
const dm6300_reg_value_t dm6300_init5_regs[] = {
    ...
    {0x6, 0xFF0, 0x00000000, 0x00000018},
    {0x3, 0x778, 0x00000000, 0x80000A80}, // 0x80000A80 0x00400680
    {0x3, 0x77C, 0x00000000, 0x0D000000}, // 0x0D000000 0x0D800680
    {0x3, 0x780, 0x00000000, 0x80000A80}, // 0x80000A80 0x00400680
    {0x3, 0x784, 0x00000000, 0x0D000000}, // 0x0D000000 0x0D800680
    {0x3, 0x788, 0x00000000, 0x0FFFFFFF},
    {0x3, 0x78C, 0x00000000, 0x00300FD6}, // 0x00300FD6 0x80080FD5
    {0x3, 0x384, 0x00000000, 0x00075075},
    {0x3, 0x38C, 0x00000000, 0x00075075},
    {0x3, 0x390, 0x00000000, 0x042F5444},
    {0x3, 0x394, 0x00000000, 0x2E788108},
    {0x3, 0x398, 0x00000000, 0x2E788128},
    {0x3, 0x39C, 0x00000000, 0x2C80C0C8},
    {0x3, 0x3A0, 0x00000000, 0x00006868},
    {0x3, 0x3A4, 0x00000000, 0x04150404},
    {0x3, 0x3A8, 0x00000000, 0x00000000},
    {0x3, 0x3AC, 0x00000000, 0x00000000},
    {0x3, 0x3B0, 0x00000000, 0x00000000},
    {0x3, 0x3D8, 0x00000000, 0x0000000A},
    {0x3, 0x380, 0x00000000, 0x075F8000},
    {0x3, 0x388, 0x00000000, 0x075F8000},
    {0x0, 0x000, 0x00000000, 0x00000000}, // padding
};
...
const dm6300_reg_value_t dm6300_init7_regs_bw20[] = {
    ...
    {0x3, 0xC08, 0x00000000, 0xFFB2FF8D},
    {0x3, 0xC0C, 0x00000000, 0x006B0011},
    {0x3, 0xC10, 0x00000000, 0x003E0080},
    {0x3, 0xC14, 0x00000000, 0xFF78FFCE},
    {0x3, 0xC18, 0x00000000, 0xFFD4FF78},
    {0x3, 0xC1C, 0x00000000, 0x00A30052},
    {0x3, 0xC20, 0x00000000, 0x0018008C},
    {0x3, 0xC24, 0x00000000, 0xFF43FF8C},
    {0x3, 0xC28, 0x00000000, 0x0001FF71},
    {0x3, 0xC2C, 0x00000000, 0x00D80099},
    {0x3, 0xC30, 0x00000000, 0xFFE2008E},
    {0x3, 0xC34, 0x00000000, 0xFF0CFF3D},
    {0x3, 0xC38, 0x00000000, 0x0042FF77},
    {0x3, 0xC3C, 0x00000000, 0x011200F2},
    {0x3, 0xC40, 0x00000000, 0xFF910081},
    {0x3, 0xC44, 0x00000000, 0xFECDFED5},
    {0x3, 0xC48, 0x00000000, 0x00A9FF8D},
    {0x3, 0xC4C, 0x00000000, 0x01580170},
    {0x3, 0xC50, 0x00000000, 0xFF0C005D},
    {0x3, 0xC54, 0x00000000, 0xFE7AFE38},
    {0x3, 0xC58, 0x00000000, 0x015DFFC4},
    {0x3, 0xC5C, 0x00000000, 0x01C20240},
    {0x3, 0xC60, 0x00000000, 0xFE060007},
    {0x3, 0xC64, 0x00000000, 0xFDE4FD0A},
    {0x3, 0xC68, 0x00000000, 0x03050054},
    {0x3, 0xC6C, 0x00000000, 0x02BD0434},
    {0x3, 0xC70, 0x00000000, 0xFAB7FEEF},
    {0x3, 0xC74, 0x00000000, 0xFB99F8D8},
    {0x3, 0xC78, 0x00000000, 0x0E9D0376},
    {0x3, 0xC7C, 0x00000000, 0x20271979},
    {0x3, 0xC80, 0x00000000, 0x19792027},
    {0x3, 0xC84, 0x00000000, 0x03760E9D},
    {0x3, 0xC88, 0x00000000, 0xF8D8FB99},
    {0x3, 0xC8C, 0x00000000, 0xFEEFFAB7},
    {0x3, 0xC90, 0x00000000, 0x043402BD},
    {0x3, 0xC94, 0x00000000, 0x00540305},
    {0x3, 0xC98, 0x00000000, 0xFD0AFDE4},
    {0x3, 0xC9C, 0x00000000, 0x0007FE06},
    {0x3, 0xCA0, 0x00000000, 0x024001C2},
    {0x3, 0xCA4, 0x00000000, 0xFFC4015D},
    {0x3, 0xCA8, 0x00000000, 0xFE38FE7A},
    {0x3, 0xCAC, 0x00000000, 0x005DFF0C},
    {0x3, 0xCB0, 0x00000000, 0x01700158},
    {0x3, 0xCB4, 0x00000000, 0xFF8D00A9},
    {0x3, 0xCB8, 0x00000000, 0xFED5FECD},
    {0x3, 0xCBC, 0x00000000, 0x0081FF91},
    {0x3, 0xCC0, 0x00000000, 0x00F20112},
    {0x3, 0xCC4, 0x00000000, 0xFF770042},
    {0x3, 0xCC8, 0x00000000, 0xFF3DFF0C},
    {0x3, 0xCCC, 0x00000000, 0x008EFFE2},
    {0x3, 0xCD0, 0x00000000, 0x009900D8},
    {0x3, 0xCD4, 0x00000000, 0xFF710001},
    {0x3, 0xCD8, 0x00000000, 0xFF8CFF43},
    {0x3, 0xCDC, 0x00000000, 0x008C0018},
    {0x3, 0xCE0, 0x00000000, 0x005200A3},
    {0x3, 0xCE4, 0x00000000, 0xFF78FFD4},
    {0x3, 0xCE8, 0x00000000, 0xFFCEFF78},
    {0x3, 0xCEC, 0x00000000, 0x0080003E},
    {0x3, 0xCF0, 0x00000000, 0x0011006B},
    {0x3, 0xCF4, 0x00000000, 0xFF8DFFB2},
...
const dm6300_reg_value_t dm6300_init7_regs_bw27[] = {
    ...
    {0x3, 0xC04, 0x00000000, 0x0053005D},
    {0x3, 0xC08, 0x00000000, 0xFFF7002D},
    {0x3, 0xC0C, 0x00000000, 0xFFB1FFC7},
    {0x3, 0xC10, 0x00000000, 0xFFF0FFC1},
    {0x3, 0xC14, 0x00000000, 0x00450025},
    {0x3, 0xC18, 0x00000000, 0x0009003B},
    {0x3, 0xC1C, 0x00000000, 0xFF98FFC6},
    {0x3, 0xC20, 0x00000000, 0xFFD2FF9A},
    {0x3, 0xC24, 0x00000000, 0x00670024},
    {0x3, 0xC28, 0x00000000, 0x00380071},
    {0x3, 0xC2C, 0x00000000, 0xFF79FFD4},
    {0x3, 0xC30, 0x00000000, 0xFF94FF5C},
    {0x3, 0xC34, 0x00000000, 0x0085000B},
    {0x3, 0xC38, 0x00000000, 0x008A00BC},
    {0x3, 0xC3C, 0x00000000, 0xFF620000},
    {0x3, 0xC40, 0x00000000, 0xFF2DFF09},
    {0x3, 0xC44, 0x00000000, 0x0093FFCA},
    {0x3, 0xC48, 0x00000000, 0x010D011B},
    {0x3, 0xC4C, 0x00000000, 0xFF640060},
    {0x3, 0xC50, 0x00000000, 0xFE88FE9F},
    {0x3, 0xC54, 0x00000000, 0x007DFF42},
    {0x3, 0xC58, 0x00000000, 0x01E70195},
    {0x3, 0xC5C, 0x00000000, 0xFF9C0127},
    {0x3, 0xC60, 0x00000000, 0xFD5BFE0B},
    {0x3, 0xC64, 0x00000000, 0x000FFE15},
    {0x3, 0xC68, 0x00000000, 0x03B9025D},
    {0x3, 0xC6C, 0x00000000, 0x007B0323},
    {0x3, 0xC70, 0x00000000, 0xF9E2FCC5},
    {0x3, 0xC74, 0x00000000, 0xFDD2F9D3},
    {0x3, 0xC78, 0x00000000, 0x0F7905A3},
    {0x3, 0xC7C, 0x00000000, 0x1DE41880},
    {0x3, 0xC80, 0x00000000, 0x18801DE4},
    {0x3, 0xC84, 0x00000000, 0x05A30F79},
    {0x3, 0xC88, 0x00000000, 0xF9D3FDD2},
    {0x3, 0xC8C, 0x00000000, 0xFCC5F9E2},
    {0x3, 0xC90, 0x00000000, 0x0323007B},
    {0x3, 0xC94, 0x00000000, 0x025D03B9},
    {0x3, 0xC98, 0x00000000, 0xFE15000F},
    {0x3, 0xC9C, 0x00000000, 0xFE0BFD5B},
    {0x3, 0xCA0, 0x00000000, 0x0127FF9C},
    {0x3, 0xCA4, 0x00000000, 0x019501E7},
    {0x3, 0xCA8, 0x00000000, 0xFF42007D},
    {0x3, 0xCAC, 0x00000000, 0xFE9FFE88},
    {0x3, 0xCB0, 0x00000000, 0x0060FF64},
    {0x3, 0xCB4, 0x00000000, 0x011B010D},
    {0x3, 0xCB8, 0x00000000, 0xFFCA0093},
    {0x3, 0xCBC, 0x00000000, 0xFF09FF2D},
    {0x3, 0xCC0, 0x00000000, 0x0000FF62},
    {0x3, 0xCC4, 0x00000000, 0x00BC008A},
    {0x3, 0xCC8, 0x00000000, 0x000B0085},
    {0x3, 0xCCC, 0x00000000, 0xFF5CFF94},
    {0x3, 0xCD0, 0x00000000, 0xFFD4FF79},
    {0x3, 0xCD4, 0x00000000, 0x00710038},
    {0x3, 0xCD8, 0x00000000, 0x00240067},
    {0x3, 0xCDC, 0x00000000, 0xFF9AFFD2},
    {0x3, 0xCE0, 0x00000000, 0xFFC6FF98},
    {0x3, 0xCE4, 0x00000000, 0x003B0009},
    {0x3, 0xCE8, 0x00000000, 0x00250045},
    {0x3, 0xCEC, 0x00000000, 0xFFC1FFF0},
    {0x3, 0xCF0, 0x00000000, 0xFFC7FFB1},
    {0x3, 0xCF4, 0x00000000, 0x002DFFF7},
    {0x3, 0xCF8, 0x00000000, 0x005D0053},
    {0x3, 0xCFC, 0x00000000, 0x0041004E},
};
