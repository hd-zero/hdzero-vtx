...
#define MSP_CMD_FC_VARIANT     0x02 // 2   //out message
#define MSP_CMD_VTX_CONFIG     0x58 // 88  //out message
#define MSP_CMD_SET_VTX_CONFIG 0x59 // 89  // in message
#define MSP_CMD_STATUS         0x65 // 101 //out message
#define MSP_CMD_RC             0x69 // 105 //out message
#define MSP_CMD_DISPLAYPORT    0xB6 // 182 // in message
#define MSP_CMD_SET_OSD_CANVAS 0xBC // 188 // in message
